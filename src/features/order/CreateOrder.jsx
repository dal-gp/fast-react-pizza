...
function CreateOrder() {
  ...
  return (
    <div className="px-4 py-6">
       ...
       */}
      <Form method="POST">
        {/* Label + input: stacked on mobile, side-by-side from sm+ */}
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          <label className="sm:basis-40">First Name</label>
          {/* grow fills remaining flex space - don't use w-full on direct flex children */}
          {/* defaultValue (not value) - pre-filled from Redux but still editable by user
          value={username} would make it read-only (no onChange to update it) */}
          <input
            type="text"
            name="customer"
            required
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {/* Wrapper div gets grow; input inside gets w-full (not a direct flex children) */}
          <div className="grow">
